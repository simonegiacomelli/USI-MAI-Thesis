...
The hyperparameter tuning was performed on a subset of the mined dataset. Such subset is composed by 106,272 instances (53,136 pairs) and features methods having less than 200 tokens. Such constraint was mainly due to the high cost of training when dealing with longer methods; an example of a method composed of 199 tokens is shown in listing \ref{lst:snippet199}.
