...
%To answer RQ$_3$ 
We %trained and 
tested the model on two scenarios with different code snippet lengths. Then we conducted a qualitative analysis on samples of high confidence predictions. We trace the AST-paths and the related attention vector weights back to the training instances in order to show and explain reasons of specific outcomes.
